...
%% Photodiode params
% define the background and stimulus
backColor = [0, 0, 0]; % black
stimColor = [255, 255, 255]; % [1500, 1500, 1500]; % white
backDiameter = 35;
stimDiameter = 33;
backPos = [4, screenHeight - 20]; % adjust to fit your diode position
stimPos = [4, screenHeight - 20]; % adjust to fit your diode position
...
Screen('DrawDots',ptbWindow, backPos, backDiameter, backColor,[],1); % black background for photodiode
...
for thisTrial = 1:experiment.nTrials
    ...
    % send trigger
    Screen('DrawDots',ptbWindow, backPos, backDiameter, backColor,[],1); % Photodiode
    Screen('DrawDots',ptbWindow, stimPos, stimDiameter, stimColor,[],1); % Photodiode
